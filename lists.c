...
/**
 * add_node - this adds the node at the start of list
 * @head: this is the address of pointer to head node
 * @str: str the field of the node
...
/**
 * print_list_str – this prints only the str element of the list_t linked list
...
/**
 * free_list – this frees all the nodes of a the list
 * @head_ptr: the address of the pointer to the head node
 *
 * Return: does return void
 */
