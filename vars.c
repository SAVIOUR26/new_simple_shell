...
/**
 * is_chain - this tests if current char in buffer is the chain delimiter
 * @info: parameter struct
 * @buf: char buffer
 * @p: address of the current position in the buffer
 *
 * Return: if chain delimiter 1, else 0 
 */
...
/**
 * check_chain – this checks whether to proceed chaining based on the last status
 * @info: parameter struct
 * @buf: char buffer
...
/**
 * replace_vars – this replaces vars in tokenized string
