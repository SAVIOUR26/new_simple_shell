 ...
 * @num: number field
 * @str: string
 * @next: this points at the next node
 */
...
/**
 * struct passinfo - comprises pseudo-arguments 2 pass into a func,
 * allowing unchanging prototype 4 func pointer struct
 * @arg: the string created from getline comprising arguments
 * @argv: array of  the strings created from arg
 ...
 * @cmd_buf: the address of the pointer 2 cmd_buf, on if chaining
 * @cmd_buf_type: CMD_type ||, &&, ;
 * @readfd: the fd from which 2 read  the line input
...
/**
 * struct builtin – this contains a builtin string & associated function
